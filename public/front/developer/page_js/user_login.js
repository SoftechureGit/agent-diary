...
$(document).ready(function () {
    ...
    $('#login_user').click(function () {
        if ($("#login-form").valid()) {
			...
			var type= $('input[name=signv]:checked').val();
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                 ...
                 if(data.error)
                    ...
                    {
						if(data.response==2)
						{   if(data.user_kyc==0 || data.user_kyc==1)
                            {
                               
							   window.location=BASE_URL+"/builder/edit-profile";
                            }
                            else 
                            {   
                                window.location=BASE_URL+"/builder/dashboard";
                            }
						}
