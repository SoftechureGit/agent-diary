...
<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
    <tr>
        ...
        <td style="background-color:;width:40%;"><h1 align="center">Perfoma INVOICE</h1><span style="font-size:14px;font-weight:normal;"><span style="color:#222222c7;">Ref. No:</span> <span style='color:red;'>$invoice_detail->invoice_id</span><br><span style="color:#222222c7;">Date:</span> <span style='color:red;'>$invoice_detail->invoice_date</span><br><span style="color:#222222c7;">Customer Id:</span> <span style='color:red;'>$invoice_detail->user_id</span><br><span style="color:#222222c7;">Status:</span> <span style='color:red;'>Unpaid</span>
        </span>
        </td>
    </tr>
</table>
...
<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
    <tr>
        <td style="width:70%;"><span style="font-size:14px;">$amount_words</span>
        </td>
...
<table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
    <tr>
        ...
        <td style="background-color:;width:30%;"><span style="font-size:14px;font-weight:normal;color:#222222c7;">$setting->invoice_company_name</span><br><br><br><br><span style="font-size:14px;font-weight:normal;color:#222222c7;">Authorized Signatury</span>
        </td>
    </tr>
    <tr>
        ...
        <br>
        <span style="font-size:12px;font-weight:normal;color:#222222c7;">* <a style='color:#222222c7;' href="$base_url">Terms & Conditions</a> Applicable</span>
        </td>
    </tr>
</table>
EOD;
...
if ($this->input->get('view')==1) {
    $pdf->Output('PerfomaInvoice-'.time().'.pdf', 'I');
}
else if (isset($pdf_send_mail)) {
   
$FileNamePath = FCPATH.'/uploads/tmppdf/PerfomaInvoice-'.$invoice_detail->invoice_id.'.pdf';
...
$pdf->Output('PerfomaInvoice-'.time().'.pdf', 'D');
}
