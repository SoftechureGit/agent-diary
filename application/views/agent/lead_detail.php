                                ...
                                <div class="basic-form">
                                    ...
                                    <form method="post" id="form-modal" autocomplete="off">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>Mobile:</label>
                                                <input type="text" class="form-control" placeholder="" id="lead_mobile_no" name="lead_mobile_no" value="<?php if($id) { echo $lead_detail->lead_mobile_no; } ?>" required="" <?php if($id) { echo 'disabled'; } ?> maxlength='10'>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>Email:</label>
                                                <input type="text" class="form-control" placeholder="" id="lead_email" name="lead_email" value="<?php if($id) { echo $lead_detail->lead_email; } ?>"  <?php if($id) { echo 'disabled'; } ?>>
                                            </div>
