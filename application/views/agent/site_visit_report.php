                          ...
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      <p>Total Site Visit: <span class="total_records">0</span></p>
                                  </div>
                              ...
                              <div class="col-md-7">
                                  <div style="display:;height: 535px;overflow-y: auto;">
                                  ...
                                  <div class="pl-5 pr-5 search_box">
                                      <h4 class="text-center">All Site Visit</h4>
                                      ...
                                      <form class="mt-4" method="post" onsubmit="return searchData()">
                                          ...
                                          <div class="form-group advance_search" style="padding-bottom: 8px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                  <select class="form-control" id="search_project_id" name="search_project_id" style="height: 38px;border-radius: 6px;margin-top: 10px;">
                                                ...
                                                <div class="col-md-6">
                                                  <select class="form-control" id="search_builder_id" name="search_builder_id" style="height: 38px;border-radius: 6px;margin-top: 10px;">
                                                     <option value="">Select Builder</option>
                                                      <?php foreach ($builder_list as $item) { ?>
							                            <option value="<?= $item->builder_id ?>"><?= $item->firm_name ?></option>
							                        <?php } ?>
                                                 </select>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                  <select class="form-control" id="search_response" name="search_response" style="height: 38px;border-radius: 6px;margin-top: 10px;">
                                                ...
                                                <div class="col-md-6">
                                                  <select class="form-control" id="search_staff_id" name="search_staff_id" style="height: 38px;border-radius: 6px;margin-top: 10px;">
                                                     <option value="">Select Staff</option>
                                                      <?php foreach ($user_list as $item) { ?>
	                        								    <option value="<?= $item->user_id ?>"><?= trim(ucwords($item->user_title.' '.$item->first_name.' '.$item->last_name)) ?></option>
	                        							<?php } ?>
                                                 </select>
                                                </div>
                                          ...
                                          <div class="form-group text-right">
                                            ...
                                            <br>
                                            <button type="button" class="btn btn-info" style="margin-left: 15px;margin-top: 15px;" onclick="downloadReport()">Download Report</button>
                                        </div>
                                      </form>
	                                    	...
	                                    	<div class="row">
							                    <div class="col-lg-6 col-sm-6">
							                        <div class="card gradient-1">
							                            <div class="card-body" style="padding: 13px 10px 4px 10px !important;text-align: center;">
							                                <h3 class="card-title text-white" style="font-size: 14px;margin-bottom: 5px;">Total Visit</h3>
							                                <div class="d-inline-block">
							                                    <h2 class="text-white" style="font-size: 24px;"><?= $total_visit ?></h2>
							                                </div>
							                            </div>
							                        </div>
							                    </div>
							                    <div class="col-lg-6 col-sm-6">
							                        <div class="card gradient-2">
							                            <div class="card-body" style="padding: 13px 10px 4px 10px !important;text-align: center;">
							                                <h3 class="card-title text-white" style="font-size: 14px;margin-bottom: 5px;">Today Visit</h3>
							                                <div class="d-inline-block">
							                                    <h2 class="text-white" style="font-size: 24px;"><?= $today_visit ?></h2>
							                                </div>
							                            </div>
							                        </div>
							                    </div>
    ...
    <div class="modal-dialog modal-md" budget="document">
        <div class="modal-content">
            ...
            <form id="action-form-modal" method="post">
                <input type="hidden" class="form-control" name="bk_id" id="bk_id" value="">
                <input type="hidden" class="form-control" id="bk_status" name="bk_status" value="">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 sv_success" style="margin-top: 10px;">
                            <label>Date & Time of visit:</label>
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" class="form-control material_date" name="bk_visit_date" id="bk_visit_date" placeholder="Date" value="" />
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control material_time" name="bk_visit_time" id="bk_visit_time" placeholder="Time" value="" />
                                </div>
                            </div>
                        </div>

	                    <div class="form-group col-md-12 sv_success">
	                        <label for="budget_name" class="col-form-label">Attend By:</label>
	                        <input type="text" class="form-control" name="bk_attend_by" id="bk_attend_by" placeholder="" value="" />
	                    </div>
                    	
	                    <div class="form-group col-md-12 sv_success">
	                        <label><input type="radio" name="bk_interested" value="1"> Interested</label> <label><input type="radio" name="bk_interested" value="2"> Not Interested</label>
	                    </div>

	                    <div class="form-group col-md-12">
	                        <label for="budget_name" class="col-form-label cmt">Comment:</label>
...
function downloadReport(){
	if ($(".total_records").text()==0) {
		alert('No Records');

	}
	else {	    var filter_by = $("#filter_by").val();
	    var search_text = $("#search_text").val();
	    var search_date_from = $("#search_date_from").val();
	    var search_date_to = $("#search_date_to").val();
	    var search_project_id = $("#search_project_id").val();
	    var search_builder_id = $("#search_builder_id").val();
	    var search_staff_id = $("#search_staff_id").val();
	    var search_response = $("#search_response").val();
	    var search_status = $("#search_status").val();
		window.location.href="<?php echo base_url(AGENT_URL.'api/download_site_visit'); ?>"+"?filter_by="+filter_by+"&search_text="+search_text+"&search_date_from="+search_date_from+"&search_date_to="+search_date_to+"&search_project_id="+search_project_id+"&search_builder_id="+search_builder_id+"&search_staff_id="+search_staff_id+"&search_response="+search_response+"&search_status="+search_status;
	}
}
...
function get_customer_list() {
    ...
    $.ajax({
    type: "POST",
    url: "<?php echo base_url(AGENT_URL.'api/get_site_visit_list'); ?>",
    data: {page:page,filter_by:filter_by,search_text:search_text,search_date_from:search_date_from,search_date_to:search_date_to,search_project_id:search_project_id,search_builder_id:search_builder_id,search_staff_id:search_staff_id,search_response:search_response,search_status:search_status},
    beforeSend: function() {
      $(".error-msg-left").html('');
      $(".load-more").hide();
      $(".bottom-loader").show();
          ...
          if (obj.status=='success') {
            ...
            for (var i = 0; i < records.length; i++) {
              ...
              if (record.site_visit_status=='1') {
              	site_visit_status = "<span class='badge badge-pill badge-warning' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Pending</span>";
              }
              else if (record.site_visit_status=='2') {
              	site_visit_status = "<span class='badge badge-pill badge-success' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Success</span>";
              }
              else if (record.site_visit_status=='3') {
              	site_visit_status = "<span class='badge badge-pill badge-danger' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Postpone</span>";
              }

html += "<div class='customer' style='border-bottom: 1px solid rgba(0, 0, 0, 0.125);padding-bottom: 10px;margin-bottom: 10px;' onclick='showCustomer("+record.site_visit_id+",0)'>"+
"    <div class='row'>"+
"    <div class='col-md-12' style=''>"+
"      <div class='row'>"+
"        <div class='col-md-8'>"+
"          <div class='card-text text-muted'><i class='fa fa-user'></i> "+record.lead_title+" "+record.lead_first_name+" "+record.lead_last_name+"</div>"+
"<div class='card-text text-muted' style='display:none;'><i class='fa fa-phone'></i> <span style='font-size: 12px;'>+91"+record.lead_mobile_no+"</span></div>"+

"    <div class=''>"+
"          <div class='card-text text-muted'>Project: "+record.project_name+"</div>"+
"    </div>"+
"    <div class='' style='display:;'>"+
"          <div class='card-text text-muted'>Assign To: <b>"+record.assign_to+"</b></div>"+
"    </div>"+
"        </div>"+
"        <div class='col-md-4' align='right' style='font-size: 11px;line-height: 15px !important;'>"+"<div class='text-muted sv_date_"+record.site_visit_id+"'>"+record.visit_date+"</div><div class='text-muted pt-1 sv_time_"+record.site_visit_id+"'>"+record.visit_time+"</div><div class='text-muted sv_status_"+record.site_visit_id+"'>"+site_visit_status+"</div>"+
"        </div>"+
"      </div>"+
"    </div>"+

//"    <div class='col-md-12' style='display:"+record.is_share+";'>"+
//"          <div class='card-text text-muted'>By: "+record.builder+"</div>"+
//"    </div>"+

//"    <div class='col-md-12' style='display:"+record.is_share+";'>"+
//"          <div class='card-text text-muted'>Assign To: "+record.assign_to+"</div>"+
//"    </div>"+
...
"</div>";
            ...
            if(obj.total_records==0) {
              $(".lead-list").html("<div class='text-center text-muted pt-2'>--- No Records ---</div>");
              $(".load-more").hide();
            }
              ...
              $(".load-more").hide();
              $(".lead-list").append("<div class='text-center text-muted pt-2'>--- No More Records ---</div>");
            }
          }
          else {
             $(".load-more").hide();
...
function get_customer(id,def) {
   $.ajax({
    type: "POST",
    url: "<?php echo base_url(AGENT_URL.'api/get_site_visit'); ?>",
    data: {id:id,def:def},
    beforeSend: function() {
...
function reqFormModal(id,type,lid) {
    ...
    if (type==1) {
        ...
        $("#requirementModal").modal('show');$("#fid").val('');
            ...
            var obj;
              try {
                ...
                if (obj.status=='success') {
					...
					var location_array = [];
                    if (location!=null && location!='') { location_array = location.split(','); }
...
function feedbackFormModal(id,type,lid) {
    var feedback_ids = $('.chk_btn:checked').map(function() {return this.value;}).get().join(',');
    if (type==1) {
      if (feedback_ids=="") {
...
$("#action-form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'api/update_site_visit_status') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
            ...
            var obj;
              try {
                ...
                if (obj.status=='success') {
                  ...
                  showCustomer($("#bk_id").val());

                  var site_visit_status	 = "";
	              if (obj.site_visit_status=='1') {
	              	site_visit_status = "<span class='badge badge-pill badge-warning' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Pending</span>";
	              }
	              else if (obj.site_visit_status=='2') {
	              	site_visit_status = "<span class='badge badge-pill badge-success' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Success</span>";
	              }
	              else if (obj.site_visit_status=='3') {
	              	site_visit_status = "<span class='badge badge-pill badge-danger' style='color: #fff; padding: 5px 10px; margin-top: 6px;font-size:11px;'>Postpone</span>";
	              }
	              $(".sv_status_"+obj.site_visit_id).html(site_visit_status);
	              $(".sv_date_"+obj.site_visit_id).html(obj.visit_date);
	              $(".sv_time_"+obj.site_visit_id).html(obj.visit_time);
                }
                else {
...
function updateBookingStatusConfirm(id,t,n,visit_date,visit_time) {
    $("#formModalAction").modal('show');
        $("#formModalAction .modal-title").html('Confirm '+n);
        $("#bk_id").val(id);
        $("#bk_status").val(t);
        $("#bk_comment").val('');
        $("#bk_attend_by").val('');
        $("#bk_visit_date").val(visit_date);
        $("#bk_visit_time").val(visit_time);
        if (t==2) {
        	$(".cmt").text("Comment");
        	$(".sv_success").show();

        	$('input:radio[name="bk_interested"]').change(function() {
		        if ($(this).val() == '1') {
		            $(".cmt").text("Comment");
		        } else {
        			$(".cmt").text("Reason");
		    ...
		    $("#bk_comment").prop('required',false);
        }
        else if (t==3) {
        	$(".cmt").text("Reason");
        	$(".sv_success").hide();
		    $("#bk_comment").prop('required',true);
        }

  		$("input[name=bk_interested]").prop("checked",false);
 } 
</script>