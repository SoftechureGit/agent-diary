                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                                ...
                                <!--<a href="<?= base_url(AGENT_URL.'template-detail') ?>"><button type="button" class="btn btn-info btn-sm" >Add New</button></a><?php //  } ?>-->
...
<script type="text/javascript">
    ...
    var table=$('#empTable').DataTable({
      ...
      'serverMethod': 'post',
      'ajax': {
         'url':'<?= base_url(AGENT_URL.'api/template_list') ?>'
      },
      'columns': [
         { data: 'template_id' },
...
function get_template(id) {
     $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'api/get_template') ?>",
        data: {id:id},
...
function alertMessage(type,message) {
 ...
 $("#form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'api/template_process') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
 ...
 function confirDelete(id) {
  ...
  function delete_template(id) {
    ...
    $.ajax({
    type: "POST",
    url: "<?php echo base_url(AGENT_URL.'api/delete_template'); ?>",
    data: {id:id},
