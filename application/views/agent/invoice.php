    ...
    <tbody>
        <?php $i=0; foreach ($payments as $row) { ?>
          <tr>
                ...
                <td><?php if($row->invoice_type==1) { echo "Performa Invoice"; } else if($row->invoice_type==2) { echo "TAX Invoice"; } ?></td>
                ...
                <td class="text-center">
                        ...
                        <a class="btn btn-dark btn-sm" href="<?= base_url(AGENT_URL.'invoice/'.$row->payment_id) ?>"><i class="fa fa-eye"></i></a>
                </td>
            </tr>
        <?php $i++; } ?>
