            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?php if($id) { echo "Update"; } else { "Add New"; } ?> Project</h4>
...
<div align="right">
    ...
    &nbsp;
    <button type="submit" class="btn btn-dark form-btn-2">Save & Next</button>
</div>
                 ...
                 <div class="form-group">
                    ...
                    <div id="banner_image_view">
                                                ...
                                                <div align="right">
                                                    ...
                                                    &nbsp;
                                                    <button type="submit" class="btn btn-dark form-btn-3">Update</button>
                                                </div>
                                            </form>
                                        </div>
...
function plotUnitDetail(blocks,n) {
 ...
 $("#step-1-form").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/api/product_save') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
          ...
          setTimeout(function(){
            var obj;
              try {
                ...
                $(".form-btn").html("Save & Next").prop('disabled',false);
...
$("#step-2-form").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/api/product_save2') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
        ...
        success: function (response) {
          ...
          setTimeout(function(){
            var obj;
              try {
                obj = JSON.parse(response);
                $(".form-btn-2").html("Save & Next").prop('disabled',false);
                $(".loader_progress").hide();
...
$("#step-3-form").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/api/product_save3') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
            ...
            var obj;
              try {
                ...
                if (obj.status=='success') {
                    ...
                    window.location.href="<?= base_url(AGENT_URL.'projects') ?>";
...
function removeProductImage(id) {
    $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/api/delete_product_image') ?>",
        data: {id:id},
        beforeSend: function (data) {
          $(".error-msg-img").html('');
          $(".loader_progress").show();
...
function getBuilders(builder_group_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'api/get_builders') ?>",
...
function getUnitDetails() {
  ...
  $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'api/get_unit_details') ?>",
