...
<head>
    ...
    <title>Reset Password - Agent</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card login-form mb-0 mt-1">
                            <div class="card-body pt-2 ">
                                ...
                                <div class="text-center">
                                    <h3 style="margin-bottom: 15px;padding-top: 10px;">Reset Password</h3>
                                </div>

                                <div class="error-msg"></div>
        
                                <form class="mb-1 login-input" id="login-form" method="post" autocomplete="off">
                                    <input type="hidden" class="form-control" placeholder="" name="reset_code" value="<?= $id ?>">
                                    ...
                                    <button class="btn btn-dark submit w-100 form-btn">Update Password</button>
                                </form>
...
function alertMessage(type,message) {
 ...
 $("#login-form").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/reset_password_process') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
