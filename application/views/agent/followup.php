            ...
            try {
              ...
              if (obj.status=='success') {
                ...
                for (var i = 0; i<feedback_list.length; i++) {
                  ...
                  var visit_status = "";
                  if (feedback_list[i].visit_status=="Yes") { visit_status = "<i class='fa fa-thumbs-o-up text-info' style='font-size:22px;font-weight:bold;'></i>"; }
                  else if (feedback_list[i].visit_status=="No") { visit_status = "<i class='fa fa-thumbs-o-down text-danger' style='font-size:22px;font-weight:bold;'></i>"; }
