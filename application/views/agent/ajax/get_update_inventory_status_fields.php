<div class="row">
   ...
   <div class="form-group col-md-4">
      ...
      <select class="form-control" id="accomodation_id" name="accomodation_id" onchange="getBasicCostData('1')">
   ...
   <div class="form-group col-md-4">
      ...
      <select class="form-control" id="inventory_status" name="inventory_status" onchange="getBasicCostData()">
       <option value="">Select Status</option>

      <?php foreach ($inventory_status_list as $item) { ?>
        <option value="<?= $item->inventory_status_id ?>" ><?= $item->inventory_status_name ?></option>
      <?php } ?>
    </select>
...
<div class="update_basic_cost_list" style="margin-top: 15px;">
    ...
    <div class="row" style="margin-top: 15px;">
	   ...
	   <div class="col-md-6">
	      <div class="row">
	         <div class="col-md-6">
	            <select class="form-control" id="new_inventory_status" name="new_inventory_status" required="" disabled>
	               <option value="">Select Status</option>
