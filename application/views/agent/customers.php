...
function get_customer_list() {
    ...
    $.ajax({
    type: "POST",
    url: "<?php echo base_url(AGENT_URL.'api/get_customer_list'); ?>",
...
"        </div>"+
"        <div class='col-md-4' align='right' style='font-size: 11px;line-height: 15px !important;'>"+"<div class='text-muted l_next_followup_"+record.lead_id+"'>"+record.lead_date+"</div><div class='text-muted pt-1'>"+record.lead_stage_name+"</div><div class='text-muted'>"+record.lead_source_name+"</div>"+
"        </div>"+
"      </div>"+
"    </div>"+
"  </div>"+
"</div>";
            ...
            if(obj.total_records==0) {
              $(".lead-list").html("<div class='text-center text-muted pt-2'>--- No Customer ---</div>");
              $(".load-more").hide();
            }
              ...
              $(".load-more").hide();
              $(".lead-list").append("<div class='text-center text-muted pt-2'>--- No More Customer ---</div>");
            }
          }
          else {
             $(".load-more").hide();
...
function get_customer(id,def) {
   $.ajax({
    type: "POST",
    url: "<?php echo base_url(AGENT_URL.'api/get_customer'); ?>",
    data: {id:id,def:def},
    beforeSend: function() {
