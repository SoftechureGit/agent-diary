...
$("#inventory-form").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(AGENT_URL.'/api/basic_cost_update') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
...
function selectProject() {
   ...
   var product_id = $("#product_id").val();
    ...
    $.ajax({
         type: "POST",
         url: "<?= base_url(AGENT_URL.'api/get_update_basic_cost_fields') ?>",
...
function getBasicCostData(f='') {
   ...
   $.ajax({
         ...
         data: {product_id:product_id,unit_code:unit_code,floor_id:floor_id,tower_id:tower_id},
         beforeSend: function (data) {
         },
         success: function (response) {
           var obj;
