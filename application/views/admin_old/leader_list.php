...
<style type="text/css">
  .hgh{    background: white;
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Leader List</h3>
            <table id="dataTable" class="table table-bordered" style="text-align: center;">
              ...
              <tbody>
                 <?php $i=0; foreach ($leader_list as $key => $list) {  ?>
                <tr>
                  <td><?php echo $i+1; ?></td>
                  <td><?php echo $list['leader_name']; ?></td>
                  <td><?php echo $list['state_name']; ?></td>
                  <td><?php echo $list['district_name']; ?></td>
                  <td><?php echo $list['contact_no']; ?></td>
                  <td><a href="<?php echo base_url(ADMIN_URL.'/leader-single/'.$list['leader_id']); ?>"><i class="fa fa-edit"></i></a></td>
                </tr>
              <?php $i++; } ?>
              </tbody>
            </table>
