...
<style type="text/css">
  .hgh{    background: white;
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
         <a style="float: right;" href="<?php echo base_url(ADMIN_URL.'/event-add-comment/'.$id); ?>" class="btn btn-primary">Add Comment</a>
        </div>
      </div>
      <div class="col-md-12">
          <div class="tile">
            ...
            <table id="dataTable" class="table table-bordered" style="text-align: center;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url(ADMIN_URL.'/event-update-comment/'.$list['comment_id']); ?>"><i class="fa fa-edit"></i></a> </td>
                </tr>
              <?php $i++; } ?>
              </tbody>
            </table>
