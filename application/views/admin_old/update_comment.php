      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Update Comment</h3>
                    <div class="col-md-12">
                        <form method="post" action="<?php echo base_url(ADMIN_URL.'/comment-query/'.$id) ;?>">
                           <div class="row">
                            <div class="form-group col-md-6">
                            <label for="cat_name">Commenter Name</label>
                            <input type="hidden" name="news_id" placeholder="" value="<?php if($id){ echo $comment_single->news_id;}elseif($news_id){echo $news_id;} ?>" class="form-control">
