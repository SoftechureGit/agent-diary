...
<style type="text/css">
  .hgh{    background: white;
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Gallery Category List</h3>
            <table id="dataTable" class="table table-bordered" style="text-align: center;">
              ...
              <tbody>
                 <?php $i=0; foreach ($gallery_cat_list as $key => $list) {  ?>
                <tr>
                  <td><?php echo $i+1; ?></td>
                  <td><?php echo $list->category_title; ?></td>
                  <td><a href="<?php echo base_url(ADMIN_URL.'/gallery-category-single/'.$list->gal_cat_id); ?>"><i class="fa fa-edit"></i></a></td>
                </tr>
              <?php $i++; } ?>
              </tbody>
            </table>
