                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form" id="printableArea" style="margin-top: 30px;">

                                        <div class="form-row">

                                          <div class="col-md-12">
                                            <iframe src="<?= base_url('pdf-receipt/'.$invoice_detail->order_id) ?>?view=1" style="width:100%; height:100vh;" frameborder="0"></iframe>  
                                          </div>

                                            <!--<div class="col-md-3">
                                                <div><label>INVOICE NO </label> </div>
                                                <div><span style="color: #333;"><?= $invoice_detail->payment_id ?></span></div>
                                            </div>

                                            <div class="col-md-3">
                                                <div><label>INVOICE DATE </label> </div>
                                                <div><span style="color: #333;"><?= $invoice_detail->receipt_date ?></span></div>
                                            </div>
                                            ...
                                            <div class="col-md-8" style="margin-top: 10px;">
                                                ...
                                                <div style="color: #333;"><?= $invoice_detail->name ?></div>
                                            </div>

                                            <div class="col-md-4" style="margin-top: 10px;">
                                                <div><label><?= SITE_TITLE ?></label> </div>
                                                <div style="color: #333;">501 Vaisali Nagar, Jaipur</div>
                                                <div style="color: #333;">8888888888</div>
                                                <div style="color: #333;">info@gmail.com</div>
                                            </div>
                                            ...
                                            <div class="col-md-12" style="margin-top: 30px;">
                                              ...
                                              <div class="table-responsive">
                                                <table class="table table-bordered">
                                                  ...
                                                  <tr>
                                                    <td>Plan PRO</td>
                                                    <td class="text-center"><?= ($invoice_detail->amount_per_user)?"Rs.".str_replace(".00", "", $invoice_detail->amount_per_user):"" ?></td>
                                                    <td class="text-center"><?= $invoice_detail->no_of_user ?></td>
                                                    <td class="text-center"><?= ($invoice_detail->monthly_cost>0)?"Rs.".str_replace(".00", "", $invoice_detail->monthly_cost):"" ?></td>
                                                    <td class="text-center"><?= ($invoice_detail->total_amount)?"Rs.".str_replace(".00", "", $invoice_detail->total_amount):"" ?></td>
                                                  </tr>
                                                </table>
                                              </div>
                                            </div>
                                             ...
                                             <div class="col-md-6">
                                                <div>INVOICE TOTAL: </div> <div style="color: #333;font-weight: bold;font-size: 23px;"><?= ($invoice_detail->total_amount)?"Rs.".str_replace(".00", "", $invoice_detail->total_amount):"" ?></div>
                                            </div>

                                             <div class="col-md-6" align="right">
                                                <label>Total: </label> <span style="color: #333;font-weight: bold;"><?= ($invoice_detail->total_amount)?"Rs.".str_replace(".00", "", $invoice_detail->total_amount):"" ?></span>
                                            </div>-->
...
$.ajax({
type: "POST",
url: "<?= base_url(ADMIN_URL.'/api/send_receipt') ?>",
data: {
