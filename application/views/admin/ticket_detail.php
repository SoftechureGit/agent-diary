                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6" align="right">
                                        <a href="<?= base_url(ADMIN_URL.'tickets') ?>"><button type="button" class="btn btn-dark btn-sm" >Back</button></a><?php //  } ?>
                                    </div>
                                </div>
		                                ...
		                                <div class="bootstrap-media">
		                                    <div class="media">
		                                    	<?php 
								                    ...
								                    if ($ticket_message_row->sender_id==1) {
							                    ...
							                    ?>
							                    <?php if ($ticket_message_row->sender_id!=1) { ?>
		                                        <img class="mr-3" src="<?= $user_image ?>" alt="User Image" style="width: 50px;height: 50px;border-radius: 50%;">
							                    <?php } ?>
		                                        <div class="media-body">
		                                            <h5 class="mt-0 mb-1"><?php if ($ticket_message_row->sender_id==1) { echo $ticket_message_row->s_first_name.' '.$ticket_message_row->s_last_name; } else { echo $ticket_message_row->r_first_name.' '.$ticket_message_row->r_last_name; } ?></h5><?= $ticket_message_row->ticket_message; ?>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.16.0/jquery.validate.min.js"></script>
 ...
 $("#form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/update_ticket_status') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
 ...
 $("#form-modal-3").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/ticket_reply') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
