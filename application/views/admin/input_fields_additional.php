...
$where = "price_component_status='1' and price_group_id='3'";
...
<div class="row margin-add additional_<?= time() ?>" style="margin-bottom: 15px;">
  <input type="hidden" name="add_detail[<?= time() ?>][product_additional_detail_id]" value=''>
  <div class="col-md-4 col-sm-4 col-xs-12">
     <label for="area">Select Component:</label>
     <select class="form-control" id="a_box" name="add_detail[<?= time() ?>][price_comp_id]">
  ...
  <div class="col-md-4 col-sm-4 col-xs-8">
     <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6">
           ...
           <input type="text" name="add_detail[<?= time() ?>][price]" class="form-control" id="area" value="">
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6 padding-left-none">
           <label><input class="checkgst" type="checkbox" id="chkgst_additional_<?= time() ?>" name="add_detail[<?= time() ?>][gst_check]" value="1" > &nbsp;&nbsp;GST</label>
           <div class="dvGst2" style="">
              <input class="form-control inputgst_additional_<?= time() ?>" style="display: none;" type="text" name="add_detail[<?= time() ?>][gst]" id="txtGstNumber" placeholder="Enter GST value">
           </div>
        </div>
     </div>
  </div>
  <div class="col-md-3 col-sm-3 col-xs-4 padding-left-none">
     ...
     <select class="form-control" id="a_box2" name="add_detail[<?= time() ?>][unit]">
