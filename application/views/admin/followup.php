                          ...
                          <div class="row">
                              ...
                              <div class="col-md-5">
                                <div class="row">
                                  ...
                                  <div class="col-md-12">
                                      <p>Total Followup: <span class="total_records">0</span></p>
                                  </div>
...
function get_followup_list() {
    ...
    $.ajax({
    type: "POST",
    url: "<?php echo base_url(ADMIN_URL.'api/get_followup_list'); ?>",
...
html += "<div class='customer' style='border-bottom: 1px solid rgba(0, 0, 0, 0.125);padding-bottom: 10px;margin-bottom: 10px;' onclick='showCustomer("+record.lead_id+",0)'>"+
"    <div class='row'>"+
...
function get_followup(id,def) {
   $.ajax({
    type: "POST",
    url: "<?php echo base_url(ADMIN_URL.'api/get_followup'); ?>",
    data: {id:id,def:def},
    beforeSend: function() {
...
function add_to_followup(id) {
   $.ajax({
    type: "POST",
    url: "<?php echo base_url(ADMIN_URL.'api/add_to_followup'); ?>",
    data: {id:id},
    beforeSend: function() {
      $(".error-msg-right").html('');
...
$("#req-form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/add_requirement') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
...
function get_requirement(id) {
     $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_requirement') ?>",
        data: {id:id},
        beforeSend: function (data) {
        },
        success: function (response) {
...
function getRequirementList(lead_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_requirement_list') ?>",
...
function feedbackFormModal(id,type,lid) {
    ...
    if (type==1) {
      if (feedback_ids=="") {
       ...
       $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_feedback_single') ?>",
        data: {feedback_id:id},
        beforeSend: function (data) {
        },
        success: function (response) {
...
$("#feedback-form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/add_feedback') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
...
function getFeedbackList(lead_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_feedback_list') ?>",
        data: {lead_id:lead_id},
        beforeSend: function (data) {
...
function getFollowupList(lead_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/load_followup_list') ?>",
        data: {lead_id:lead_id},
        beforeSend: function (data) {
...
function getLeadHistoryList(lead_id) {
  ...
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_lead_history_list') ?>",
        data: {lead_id:lead_id},
        beforeSend: function (data) {
...
function followup_status_update(id,lid) {
	...
	$.ajax({
		type: "POST",
		url: "<?php echo base_url(ADMIN_URL.'api/followup_status_update'); ?>",
		data: {id:id},
		beforeSend: function (data) {
			$("#preLoading").show();
		},
...
function scrollTopScreen() {
  $('html, body').animate({scrollTop: $("body").parent().offset().top }, 1000);
}
...
$("#followup-form-modal").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/followup_save') ?>",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
...
/*function openBookingModal(lead_id) {
  ...
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_booking_form') ?>",
        data: {lead_id:lead_id},
        beforeSend: function (data) {
...
function getProductDataBooking(product_id) {
  ...
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_booking_product_data') ?>",
...
function get_booking_unit_no() {
  ...
  if (product_unit_detail_id!="") {
    $.ajax({
          type: "POST",
          url: "<?= base_url(ADMIN_URL.'api/get_booking_unit_no') ?>",
