...
function get_product_list() {
    ...
    $.ajax({
    type: "POST",
    url: "<?php echo base_url(ADMIN_URL.'api/get_product_list'); ?>",
    data: {page:page,filter_by:filter_by,search_text:search_text},
    beforeSend: function() {
      $(".error-msg-left").html('');
      $(".load-more").hide();
      $(".bottom-loader").show();
        ...
        try {
          ...
          if (obj.status=='success') {
            ...
            for (var i = 0; i < records.length; i++) {
              ...
              var action = "Action";
              if (record.accomodation_name!="") { action += ((action!='')?', ':'')+record.accomodation_name; }
...
function getAmenitiesList(id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_product_amenities_list') ?>",
        data: {id:id},
...
function getSpecificationList(id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_product_specification_list') ?>",
        data: {id:id},
        beforeSend: function (data) {
...
function getInventoryList(id,product_unit_detail_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_product_inventory_list') ?>",
        data: {id:id,product_unit_detail_id:product_unit_detail_id},
        beforeSend: function (data) {
...
function get_product_unit_single(id,def) {
   $.ajax({
    type: "POST",
    url: "<?php echo base_url(ADMIN_URL.'api/get_product_unit_single'); ?>",
    data: {id:id,def:def},
    beforeSend: function() {
...
function openFolloupModal(status,id,lid) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(ADMIN_URL.'api/get_customer_stage_status'); ?>",
        data: {id:lid},
        beforeSend: function (data) {
            $("#preLoading").show();
        },
...
function getQuatation(id){
  ...
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_product_inventory_quatation') ?>",
...
function getSiteVisitList(product_id) {
  $.ajax({
        type: "POST",
        url: "<?= base_url(ADMIN_URL.'api/get_product_site_visit_list') ?>",
