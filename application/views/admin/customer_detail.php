                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <h4 class="card-title">Customer: <?= $lead_data->customer_name ?></h4>
                                    </div>
                                    ...
                                    <table class="table table-bordered" id="empTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="width: 67px;">Date</th>
                                                <th>Purpose</th>
...
function changeType() {
    ...
    var table=$('#empTable').DataTable({
      ...
      'serverMethod': 'post',
      'ajax': {
         'url':'<?= base_url(ADMIN_URL.'api/customer_requirement_list') ?>',
       'data': function(data){
          data.name = $('#name').val();
         ...
         { 
           ...
           "render": function (data, type, row) {
                ...
                if (row.requirement_status === '1') {
                    ...
                    return "<span class='label label-pill label-danger'>Close</span>";
                }
            }
         },
         { 
