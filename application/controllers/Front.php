        ...
        if ($user_list) {
            ...
            foreach ($user_list as $user_detail) { 
                ...
                if ($user_detail->next_due_date) {
                    ...
                    $send_mail = 0;
                    if($expire_today==1){
                        echo "Today Expired -  Email:".$user_detail->email." Days:".$trial_remaining_days." Expire Date:".$user_detail->next_due_date; echo "<br>";
                        $send_mail = 1;
                    }
                    else if($trial_remaining_days==0){
                        echo "Expired -  Email:".$user_detail->email." Days:".$trial_remaining_days." Expire Date:".$user_detail->next_due_date; echo "<br>";
                        $send_mail = 1;
                    }
                    else {
                        echo "Expire in Days:".$trial_remaining_days."  Email:".$user_detail->email." Expire Date:".$user_detail->next_due_date; echo "<br>";
